    ...
    def test_kpi_endpoint(self):
        ...
        try:
            ...
            if response.status_code in [401, 403]:  # Both are valid for unauthorized access
                ...
                self.log_result("kpi_endpoint", "Permission check (no token)", False, f"Expected 401 or 403, got {response.status_code}")
        except Exception as e:
    ...
    def test_dashboard_endpoint(self):
        ...
        try:
            ...
            if response.status_code in [401, 403]:  # Both are valid for unauthorized access
                ...
                self.log_result("dashboard_endpoint", "Permission check (no token)", False, f"Expected 401 or 403, got {response.status_code}")
        except Exception as e:
